            ...
            <div class="card">
                <div class="header">
                    ...
                    <div class="header-dropdown scale-left">
                        <a href="{{url('admin/mechanics/create')}}" class="btn btn-success"><i class="icon-plus mr-1"></i> Add New </a>
                    </div>
                </div>
                <div class="body">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="{{url('admin/mechanics/'.$item->id.'/edit')}}" class="btn btn-warning">
                                            <i class="icon-pencil"></i>
                                        </a>
                                        <a href="{{url('admin/mechanics_delete/'.$item->id)}}"onclick ="return confirm('Are You Sure Delete Data??')" class="btn btn-danger">
