<!doctype html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{url('/')}}/assets/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css">
    ...
    <body class="theme-orange">
        ...
        <div class="page-loader-wrapper">
            <div class="loader">
                <div class="m-t-30"><img src="{{url('/')}}/assets/images/icon-light.svg" width="48" height="48" alt="CAR WORKSHOP"></div>
                <p>Please wait...</p>        
            </div>
        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-left">
                        <div class="navbar-btn">
                            <a href="index.html"><img src="{{url('/')}}/assets/images/icon-light.svg" alt="CAR WORKSHOP Logo" class="img-fluid logo"></a>
